...
![](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/live_config_2.png)
...
![](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/im_config_info_2.png)
...
**第二步** 安装Nodejs环境。
![](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/nodejs_setup.png)

**第三步** 修改工具包根目录下的config.js文件中的参数，替换成上述直播服务及云通信服务里生成的值。

![](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/roomtool_config.png)
...
![](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/nodejs_setconfig.png)
...
4. 打开 Demo 代码中 `simpleserver` 目录下的 `config.js` 文件，将其中的 `IM_SDKAPPID`、`IM_ACCOUNTTYPE`、`PRIVATEKEY`、配置成上述云通信服务里生成的值，同时将小程序的`WX_APPID`、`WX_APPSECRET`配置进去，并**保存**。

![serverconfig](https://github.com/TencentVideoCloudMLVBDev/MiniProgram/raw/master/image/simple_server_config.png)
